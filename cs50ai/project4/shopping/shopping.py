...
def load_data(filename):
    ...
    with open(filename) as f:
        ...
        for row in reader:
            ...
            row_evidence = [admin, admin_dur, info, info_dur, prod, prod_dur, bounce_rate, exit_rate, page_value, special_day,
                            month_num, op_sys, browser, region, traffic_type, visitor_type, weekend]
...
def evaluate(labels, predictions):
    ...
    sensitivity = num_true_predict/num_true_label
    specificity = num_false_predict/num_false_label
